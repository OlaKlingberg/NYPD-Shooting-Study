...
### Total number of shootings by borough for 2010, 2019, and 2020
```{r Shootings by borough for 2010, 2019, and 2020}
# Shootings 2010
...
```{r Visualize shootings by borough for 2010, 2019, and 2020}
# Visualize
summary_by_boro_alt %>% 
...
We see that for all three years, the Bronx is the borough with highest number of shooting incidents per million inhabitants, and Staten Island is the one with the lowest.

All five boroughs show the pattern we have already seen for the city as a whole: the numbers for 2010 and 2020 are similar to each other, and the numbers for 2019 are much lower. 
